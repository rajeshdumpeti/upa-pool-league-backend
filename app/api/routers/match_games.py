...
async def create_match_game(payload: CreateMatchGame) -> MatchGameCreated:
    ...
    return MatchGameCreated(id=fake_id, match_id=payload.match_id, game_no=payload.game_no)
...
async def complete_match_game(game_id: int, patch: CompleteMatchGame) -> MatchGamePatched:
